## THIS PYTHON FILE NEEDS TO BE RUN WITHIN THE IMAGES FOLDER WITH PNG IMAGES WHOSE
## ..FILENAMES NEED RENAMED TO NUMERICAL SEQUENCE (1.png, 2.png, 3.png, 4.png... etc.)
...
def fn_RenameFiles(files, pattern, replacement):
    ...
    ## FILE PATH TO DIRECTORY OF IMAGES
        ...
        ## RENAME FILES IN CWD; JOIN EMPTY STRING FILEPATH + STRING OF INTEGER OF CURRENT COUNTER + STRING OF .PNG 
        os.rename(os.path.join(filepath, each), os.path.join(filepath, str(i)+'.png'))
...
## CALL FUNCTION        
fn_RenameFiles("*.png", r"^(.*)\.png$", r"new(\1).png")
